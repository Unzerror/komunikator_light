...
app.lang = 'ru';
app.msg = {
    copyright: "Komunikator Copyright (C) 2012-2017, ООО 'Телефонные системы'",
    ...
    lastname: 'Фамилия',
    group: 'Группа',
    last_priority: 'Порядок обзвона',
    priority_cicle : 'Приоритетный',
    cicle : 'Круговой',
    address: 'Адрес',
    ...
    mailevent_unanswered_order_call: 'Неотвеченный вызов модуля "Перезвоните мне"',
    ...
    condition: 'Состояние',
    color: 'Цвет кнопки',
    color_after:'Цвет кнопки при наведении курсора',
    gray: 'серый',
    blue: 'синий',
    azure: 'голубой',
    green: 'зеленый',
    ...
    address_book_info: "В адресной книге указаны псевдонимы для всех телефонных номеров (входящих и исходящих). Вы можете добавлять и изменять их. Для вызова номера из адресной книги, необходимо нажать 2 раза звездочку и ввести с телефонной клавиатуры псевдоним. Например: **ABONENT (на дисплее телефона высветится номер **2266368).",
    ...
    gateways_info: "После подключения/отключения провайдера необходимо перезагрузить АТС.",
    ...
    call_history_lifespan: 'Время хранения истории звонков(кол-во месяцев)',
    call_records_lifespan: 'Время хранения записей разговоров(кол-во месяцев)',
    call_order_executor: 'Номер исполняющий заказ звонка',
    additional_settings: 'Дополнительные настройки',
    all_calls: 'Все звонки',
    ev : '№',
    qin : 'очередь',
    connect_type: 'Событие',
    caller_gateway : 'Шлюз звонящего',
    called_gateway : 'Шлюз принимающего',
    fork : 'вызов',
    call : 'разговор',
    route : 'маршрутизация',
    moh : 'удержание',
    noroute : 'нет маршрута',
    DiD : 'правило маршрутизации',
    Disabled : 'не доступен',
    noanswer_timeout : 'превышено время ожидания',
    Busy : 'занято',    
    Always : 'безусловная переадресация',
    Cycling : 'зацикливание',
    VM : 'Голосовая почта',
    AddressBook : 'Адрессная книга',
    error_route : 'неверный маршрут',
    reversCall : 'обратный вызов',
    ...
    text_call_back: 'Позволяет IP-АТС совершать звонок на введённую в web-форму номер.',
    record: 'Запись',
    ...
    stipulation: 'Условие',
    condition_return_user: 'Вернувшийся посетитель',
    condition_exit: 'Выход с сайта',
