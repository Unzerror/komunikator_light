...
app.msg = {
    ...
    lastname: 'Lastname',
    group: 'Group',
    last_priority: 'Call order',
    priority_cicle : 'Priority',
    cicle : 'Ciclic',
    address: 'Address',
    ...
    copyright: "Komunikator Copyright (C) 2012-2017, 'Telephonnyie sistemy' Ltd.",
    ...
    mailevent_unanswered_order_call: 'Unanswered order call',
    email: 'E-Mail to',
    mail1: 'Message text',
